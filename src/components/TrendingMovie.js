          ...
          return <div className="movie" key={index}>
              <div className="movie__img">
                <div className='bg__movie'>
                    <img  style={{borderRadius : "10px" , overflow: "hidden"}} src={item.regular.large} alt={movie.title}/>
                </div>
                <button className='btn btn-bookmark' onClick={() => {
                  onBookmarked(movie.title)
                }}>
                  {movie.isBookmarked ?
              ...
              <div className="movie__details" style={{fontSize : "0.85rem", fontWeight : 300 , position: "absolute" , bottom : "25px" , left : "24px"}}>
